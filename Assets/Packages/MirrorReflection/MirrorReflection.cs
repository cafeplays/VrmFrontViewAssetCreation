...
public class MirrorReflection : MonoBehaviour
{
    ...
    public Dictionary<Camera, (Camera, RenderTexture)> mirrorDatas = new Dictionary<Camera, (Camera, RenderTexture)>();
    ...
    public void OnWillRenderObject()
    {
        ...
        if (nestCount <= nestCountMax)
        {
            ...
            if (!cull)
            {
                ...
                */
                bool oldCullingState = GL.invertCulling; // Store the original state
                GL.invertCulling = nestCount % 2 == 1;

                refCam.Render(); // Render the reflection

                GL.invertCulling = oldCullingState; // Restore the original state
